...
def augment_response(source,response):
	...
	for s,r in zip(source,response):
		count_1 = len(re.findall('<p><b> You: </b>',str(s)))
		count_2 = len(re.findall('<p><b> Friend: </b>',str(s)))
		if ((count_1 + count_2 )%2) == 0: #even utterances completed!
			string = str(s) + ' <p><b> You: </b> ' + r + ' </p> ' 
		else:
			#print('printed')
			string = str(s) + ' <p><b> Friend: </b> ' + r + ' </p> ' 
...
d = {'chat_1' : chat_1 ,'comment_1' : comment_1 ,'imdb_id_1' : imdb_id_1 ,'legend_1' : legend_1 ,'movie_name_1' : movie_name_1 ,'plot_1' : plot_1 ,'review_1' : review_1 ,'wiki_1' : wiki_1 ,'chat_2' : chat_2 ,'comment_2' : comment_2 ,'imdb_id_2' : imdb_id_2 ,'legend_2' : legend_2 ,'movie_name_2' : movie_name_2 ,'plot_2' : plot_2 ,'review_2' : review_2 ,'wiki_2' : wiki_2  }
